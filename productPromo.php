...
include "../core/fidelite.php";
  //include "../core/CommentaireC.php";
		...
		$m=0;
$fidC=new FidC();
    $resultat=$fidC->recupererCin($row1['cin']);
    foreach($resultat as $ro){
	$m++;	
	}
if($m==0)
{   echo '<body onLoad="alert(\'Vous devez avoir une carte pour pouvoir accéder au promotion !\')">';
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="modifierclient.php?user=<?php echo $row1['user']; ?>" class="flex-c-m trans-04 p-lr-25">
							<?php
							if (isset($_SESSION['l']))
{
					...
					<div class="menu-desktop">
						<ul class="main-menu">
							...
							<li class="label1" data-label1="promo">
								<a href="productPack.php">Bonnes affaires</a>
								<ul class="sub-menu">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								...
								<a href="ajoutCommande.php?nom=<?php echo $row['nom'];?>&categorie=<?php echo $row2['categorieprod']?>&prix=<?php echo $row['nprix']; ?>&user=<?php echo $row1['user']; ?>">passer une commande</a>
							</div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-6 col-lg-3 p-b-50">
            ...
            <p class="stext-107 cl7 size-201"> <img src="images/icons/tel-footer.png"> Tél: (+216) 50 055 953 </br>
              <img src="images/icons/mail-footer.png"> maryem.cheriff@gmail.com</br>
          ...
          <div class="col-sm-6 col-lg-3 p-b-50">
            ...
            <p class="stext-107 cl7 size-201"> Vente de Portraits tel que
              les types . Appelez nous au (+216) 27 925 666 </p>
            <div class="p-t-27"> <a href="https://www.facebook.com/" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"> <i class="fa fa-facebook"></i> </a> </div>
          </div>
			...
			<div class="top-bar">
				<div class="content-topbar flex-sb-m h-full container">
					...
					<div class="right-top-bar flex-w h-full">
						...
						<a href="log-in.php" class="flex-c-m trans-04 p-lr-25">
							<?php
	...
	<!-- Cart -->
		...
		<div class="s-full js-hide-cart"></div>
			...
			<div class="header-cart-content flex-w js-pscroll">
						...
						<a href="log-in.php" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
							Consulter votre panier
						</a>
					</div>
				</div>
			...
			<div class="row isotope-grid" id="result-search">
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item shoes">
					...
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="log-in.php" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									<h4><?PHP echo $row['nom']; ?></h4>
								</a>
                                  <span class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
									Ancien Prix :<strike><?PHP echo $row['aprix']; ?>.000 DT</strike>
								...
								<a href="log-in.php">passer une commande</a>
							</div>
...
<footer class="bg3 p-t-75 p-b-32">
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6 col-lg-3 p-b-50">
            <h4 class="stext-301 cl0 p-b-30"> À propos </h4>
            <p class="stext-107 cl7 size-201"> </p>
            <div class="p-t-27"> <a href="https://www.facebook.com/" class="fs-18 cl7 hov-cl1 trans-04 m-r-16"> <i class="fa fa-facebook"></i> </a> </div>
          </div>
          <div class="col-sm-6 col-lg-3 p-b-50"></div>
          <div class="col-sm-6 col-lg-3 p-b-50">
